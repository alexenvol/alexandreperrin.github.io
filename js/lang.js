const translations = {
  ...
  en: {
    ...
    lego_text:
      "Personal LEGO modeling and assembly project in CATIA V5.",
    ...
    mallette_text:
      "Modular CATIA V5 design based on advanced parametric modeling.",
    ...
    sailboat_text:
      "Development of an autonomous system combining embedded electronics, mechanics and navigation.",
    ...
    guitar_text:
      "STM32 mechatronic system enabling real-time control of an automated instrument.",
